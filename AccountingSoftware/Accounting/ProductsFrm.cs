...
namespace AccountingSoftware.Accounting
{
    public partial class ProductsFrm : Form
    {
        ...
        {
            if (this.accDs1.Products.Rows.Count == 0)
            {
            ...
            try
            {
                ...
                if (sf.ShowDialog() == DialogResult.OK)
                {
                    ...
                    final_doc.Add(title);
                    //--------add subtitle-------
                    iText.Layout.Element.Paragraph sub_title = new Paragraph("Products List");
                    ...
                    table_header_loader(tbl, "Ini Qty", 1);
                    ...
                    //==============add table data==============================
                    for (int row_index = 0; row_index < this.accDs1.Products.Rows.Count; row_index++)
                    {
                        ...
                        //-------------
                        table_data_loader(tbl, this.initialQty_nud.Value.ToString("F"), 1, TextAlignment.LEFT);
                        table_data_loader(tbl, this.unit_txtBox.Text, 1, TextAlignment.LEFT);
                        table_data_loader(tbl, this.price_nud.Value.ToString("F"), 1, TextAlignment.LEFT);
        ...
        private void excel_printToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (sf.ShowDialog() == DialogResult.OK)
                {
                    ...
                    wb.AddWorksheet(this.accDs1.Products, "MySheet");
