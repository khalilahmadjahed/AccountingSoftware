...
namespace AccountingSoftware.Accounting
{
    public partial class PurchaseBillFrm : Form
    {
        ...
        private void print_toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                final_doc.Add(title);
                //--------add subtitle-------
                iText.Layout.Element.Paragraph sub_title = new Paragraph("Purchase Bill");
                ...
                //--------add bill to-----
                string a;
                a = "Bill From: ID: " + this.customerId_lbl.Text.ToString() + " | " + this.customerName_txtBox.Text;
                iText.Layout.Element.Paragraph fs = new Paragraph(a);
                final_doc.Add(fs);

                //-------invoice data---------- 
                a = "Purchase Bill ID ID: " + this.purchaseId_txtBox + " | " + this.purchaseDate_dtp.Text;
                ...
                //==============add table data==============================
                for (int row_index = 0; row_index < this.accDs1.PurchaseProduct.Rows.Count; row_index++)
                {
                    this.bindingSource2.Position = row_index;
                    ...
                    //--------------------
                    this.prog_label9.Text = "Saving Pdf " + row_index.ToString() + " of " + this.accDs1.PurchaseProduct.Rows.Count.ToString();
                    this.prog_panel1.Refresh();
                    //--------------------
                }
