...
{
    public partial class PurchaseBillListFrm : Form
    {
        public PurchaseBillListFrm()
        {
            InitializeComponent();
        }

        private void PurchaseBillListFrm_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void new_btn_Click(object sender, EventArgs e)
        {
            ...
            Int32 id;
            Int32.TryParse(this.purchaseId_txtBox.Text, out id);
            frm.sel_bill_id = id;
            frm.ShowDialog();
            //-----------------

            PurchaseBillListFrm_Load(sender, e);
        }
        ...
        private void pdf_toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (sf.ShowDialog() == DialogResult.OK)
                {
                    ...
                    final_doc.Add(title);
                    //--------add subtitle-------
                    iText.Layout.Element.Paragraph sub_title = new Paragraph("Purchase Bill List");
                    ...
                    //==============add table data==============================
                    for (int row_index = 0; row_index < this.accDs1.PurchaseBill.Rows.Count; row_index++)
                    {
                        this.bindingSource1.Position = row_index;
                        table_data_loader(tbl, this.purchaseId_txtBox.Text, 1, TextAlignment.CENTER);
                        table_data_loader(tbl, this.purchaseDate_dtp.Text, 1, TextAlignment.LEFT);
                        ...
                        //--------------------
                        this.prog_label9.Text = "Saving Pdf " + row_index.ToString() + " of " + this.accDs1.PurchaseBill.Rows.Count.ToString();
                        this.prog_panel1.Refresh();
                        //--------------------
                    }
                    ///--------------
        ...
        private void excel_printToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (sf.ShowDialog() == DialogResult.OK)
                {
                    ...
                    wb.AddWorksheet(this.accDs1.PurchaseBill, "MySheet");
