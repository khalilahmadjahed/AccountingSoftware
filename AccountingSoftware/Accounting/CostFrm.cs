        ...
        private void pdf_toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (sf.ShowDialog() == DialogResult.OK)
                {
                    ...
                    final_doc.Add(title);
                    //--------add subtitle-------
                    iText.Layout.Element.Paragraph sub_title = new Paragraph("Company Cost Report");
                    ...
                    //---------------------------
                    //=========Add table header ==================
                    Table tbl = new Table(6, true);
                    //----------------------
                    table_header_loader(tbl, "ID", 1);
                    table_header_loader(tbl, "Group", 1);
                    ...
                    //==============add table data==============================
                    for (int row_index = 0; row_index < this.accDs1.Cost.Rows.Count; row_index++)
                    {
                        this.bindingSource1.Position = row_index;
                        table_data_loader(tbl, this.costId_txtBox.Text, 1, TextAlignment.CENTER);
                        table_data_loader(tbl, this.gn_comboBox1.Text, 1, TextAlignment.LEFT);
                        table_data_loader(tbl, this.costDate_dtp.Text, 1, TextAlignment.LEFT);
                        //-------------
                        string sv = "";
                        decimal dc;
        ...
        private void excel_printToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (sf.ShowDialog() == DialogResult.OK)
                {
                    ...
                    wb.AddWorksheet(this.accDs1.Cost, "MySheet");
